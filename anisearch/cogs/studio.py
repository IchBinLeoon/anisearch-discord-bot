                            ...
                            if r.status == 200:
                                ...
                                if json['data']['Page']['studios']:
                                    ...
                                    try:
                                        ...
                                        bot.logger.info('Server: %s | Response: Studio Search - %s'
                                                        % (ctx.guild.name, name))
                    ...
                    if r.status == 200:
                        ...
                        if json['data']['Page']['studios']:
                            ...
                            try:
                                ...
                                bot.logger.info('Server: %s | Response: Studio - %s' % (ctx.guild.name, data['name']))
                            except Exception as e:
                                error_embed = discord.Embed(
...
def setup(client):
    ...
    bot.logger.info('Loaded extension Studio')


def teardown():
    bot.logger.info('Unloaded extension Studio')
