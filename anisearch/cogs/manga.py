                            ...
                            if r.status == 200:
                                ...
                                if json['data']['Page']['media']:
                                    ...
                                    try:
                                        ...
                                        bot.logger.info('Server: %s | Response: Manga Search - %s'
                                ...
                                if json['data']['Page']['media']:
                                    ...
                                    try:
                                        ...
                                        manga_embed.set_footer(text='Requested by %s' % ctx.author,
                                                               icon_url=ctx.author.avatar_url)
                                        await ctx.channel.send(embed=manga_embed)
                                        bot.logger.info('Server: %s | Response: Manga Characters - %s'
                                ...
                                if json['data']['Page']['media']:
                                    ...
                                    try:
                                        ...
                                        manga_embed.set_footer(text='Requested by %s' % ctx.author,
                                                               icon_url=ctx.author.avatar_url)
                                        await ctx.channel.send(embed=manga_embed)
                                        bot.logger.info('Server: %s | Response: Manga Staff - %s'
                                                        % (ctx.guild.name, data['title']['romaji']))
                                    except Exception as e:
                                        error_embed = discord.Embed(
                                            title='An error occurred while searching for the manga `%s` with the '
                                ...
                                if json['data']['Page']['media']:
                                    ...
                                    try:
                                        ...
                                        manga_embed.set_footer(text='Requested by %s' % ctx.author,
                                                               icon_url=ctx.author.avatar_url)
                                        await ctx.channel.send(embed=manga_embed)
                                        bot.logger.info('Server: %s | Response: Manga Image - %s'
                                                        % (ctx.guild.name, data['title']['romaji']))
                                    except Exception as e:
                                        error_embed = discord.Embed(
                                            title='An error occurred while searching for the manga `%s` with the '
                                ...
                                if json['data']['Page']['media']:
                                    ...
                                    try:
                                        ...
                                        manga_embed.set_footer(text='Requested by %s' % ctx.author,
                                                               icon_url=ctx.author.avatar_url)
                                        await ctx.channel.send(embed=manga_embed)
                                        bot.logger.info('Server: %s | Response: Manga Relations - %s'
                                                        % (ctx.guild.name, data['title']['romaji']))
                                    except Exception as e:
                                        error_embed = discord.Embed(
                                            title='An error occurred while searching for the manga `%s` with the '
                                ...
                                if json['data']['Page']['media']:
                                    ...
                                    try:
                                        ...
                                        manga_embed.set_footer(text='Requested by %s' % ctx.author,
                                                               icon_url=ctx.author.avatar_url)
                                        await ctx.channel.send(embed=manga_embed)
                                        bot.logger.info('Server: %s | Response: Manga Links - %s'
                                                        % (ctx.guild.name, data['title']['romaji']))
                                    except Exception as e:
                                        error_embed = discord.Embed(
                                            title='An error occurred while searching for the manga `%s` with the '
                                ...
                                if json['data']['Page']['media']:
                                    ...
                                    try:
                                        ...
                                        manga_embed.set_footer(text='Requested by %s' % ctx.author,
                                                               icon_url=ctx.author.avatar_url)
                                        await ctx.channel.send(embed=manga_embed)
                                        bot.logger.info('Server: %s | Response: Manga All - %s' % (ctx.guild.name,
                                                                                                   data['title'][
                                                                                                             'romaji']))
                                    except Exception as e:
                                        error_embed = discord.Embed(
                        ...
                        if json['data']['Page']['media']:
                            ...
                            try:
                                ...
                                manga_embed.set_footer(text='Requested by %s' % ctx.author,
                                                       icon_url=ctx.author.avatar_url)
                                await ctx.channel.send(embed=manga_embed)
                                bot.logger.info('Server: %s | Response: Manga - %s' % (ctx.guild.name,
                                                                                       data['title']['romaji']))
                            except Exception as e:
                                error_embed = discord.Embed(
...
def setup(client):
    ...
    bot.logger.info('Loaded extension Manga')


def teardown():
    bot.logger.info('Unloaded extension Manga')
