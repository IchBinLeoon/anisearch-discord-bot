    ...
    async def cmd_anime(self, ctx, *, title):
        ...
        if args[len(args) - 1].startswith('--'):
            if args[len(args) - 2].startswith('--'):
                ...
                bot.logger.info('Server: %s | Response: Too many command flags' % ctx.guild.name)
                            ...
                            if r.status == 200:
                                ...
                                if json['data']['Page']['media']:
                                    ...
                                    try:
                                        ...
                                        bot.logger.info('Server: %s | Response: Anime Search - %s'
                                    ...
                                    error_embed = discord.Embed(
                                        ...
                                        color=0xff0000)
                                    await ctx.channel.send(embed=error_embed)
                                    bot.logger.info('Server: %s | Response: Not found' % ctx.guild.name)
                            else:
                                error_embed = discord.Embed(
                                    title='An error occurred while searching for the anime `%s` with the '
                                          'command flag `%s`' % (title, flag),
                                    color=0xff0000)
                                await ctx.channel.send(embed=error_embed)
                                bot.logger.info('Server: %s | Response: Error' % ctx.guild.name)
                                ...
                                if json['data']['Page']['media']:
                                    ...
                                    try:
                                        ...
                                        anime_embed.set_footer(text='Requested by %s' % ctx.author,
                                                               icon_url=ctx.author.avatar_url)
                                        await ctx.channel.send(embed=anime_embed)
                                        bot.logger.info('Server: %s | Response: Anime Characters - %s'
                                ...
                                if json['data']['Page']['media']:
                                    ...
                                    try:
                                        ...
                                        anime_embed.set_footer(text='Requested by %s' % ctx.author,
                                                               icon_url=ctx.author.avatar_url)
                                        await ctx.channel.send(embed=anime_embed)
                                        bot.logger.info('Server: %s | Response: Anime Staff - %s'
                                                        % (ctx.guild.name, data['title']['romaji']))
                                    except Exception as e:
                                        error_embed = discord.Embed(
                                            title='An error occurred while searching for the anime `%s` with the '
                                ...
                                if json['data']['Page']['media']:
                                    ...
                                    try:
                                        ...
                                        anime_embed.set_footer(text='Requested by %s' % ctx.author,
                                                               icon_url=ctx.author.avatar_url)
                                        await ctx.channel.send(embed=anime_embed)
                                        bot.logger.info('Server: %s | Response: Anime Image - %s'
                                                        % (ctx.guild.name, data['title']['romaji']))
                                    except Exception as e:
                                        error_embed = discord.Embed(
                                            title='An error occurred while searching for the anime `%s` with the '
                                ...
                                if json['data']['Page']['media']:
                                    ...
                                    try:
                                        ...
                                        anime_embed.set_footer(text='Requested by %s' % ctx.author,
                                                               icon_url=ctx.author.avatar_url)
                                        await ctx.channel.send(embed=anime_embed)
                                        bot.logger.info('Server: %s | Response: Anime Relations - %s'
                                                        % (ctx.guild.name, data['title']['romaji']))
                                    except Exception as e:
                                        error_embed = discord.Embed(
                                            title='An error occurred while searching for the anime `%s` with the '
                                ...
                                if json['data']['Page']['media']:
                                    ...
                                    try:
                                        ...
                                        anime_embed.set_footer(text='Requested by %s' % ctx.author,
                                                               icon_url=ctx.author.avatar_url)
                                        await ctx.channel.send(embed=anime_embed)
                                        bot.logger.info('Server: %s | Response: Anime Links - %s'
                                                        % (ctx.guild.name, data['title']['romaji']))
                                    except Exception as e:
                                        error_embed = discord.Embed(
                                            title='An error occurred while searching for the anime `%s` with the '
                                ...
                                if json['data']['Page']['media']:
                                    ...
                                    try:
                                        ...
                                        anime_embed.set_footer(text='Requested by %s' % ctx.author,
                                                               icon_url=ctx.author.avatar_url)
                                        await ctx.channel.send(embed=anime_embed)
                                        bot.logger.info('Server: %s | Response: Anime Streams - %s'
                                                        % (ctx.guild.name, data['title']['romaji']))
                                    except Exception as e:
                                        error_embed = discord.Embed(
                                            title='An error occurred while searching for the anime `%s` with the '
                                ...
                                if json['data']['Page']['media']:
                                    ...
                                    try:
                                        ...
                                        anime_embed.set_footer(text='Requested by %s' % ctx.author,
                                                               icon_url=ctx.author.avatar_url)
                                        await ctx.channel.send(embed=anime_embed)
                                        bot.logger.info('Server: %s | Response: Anime All - %s' % (ctx.guild.name,
                                                                                                   data['title'][
                                                                                                             'romaji']))
                                    except Exception as e:
                                        error_embed = discord.Embed(
                ...
                error_embed = discord.Embed(title='The command flag is invalid or cannot be used with this command',
                                            color=0xff0000)
                await ctx.channel.send(embed=error_embed)
                bot.logger.info('Server: %s | Response: Wrong command flags' % ctx.guild.name)
                ...
                async with session.post(api, json={'query': query, 'variables': variables}) as r:
                    if r.status == 200:
                        ...
                        if json['data']['Page']['media']:
                            ...
                            try:
                                ...
                                anime_embed.set_footer(text='Requested by %s' % ctx.author,
                                                       icon_url=ctx.author.avatar_url)
                                await ctx.channel.send(embed=anime_embed)
                                bot.logger.info('Server: %s | Response: Anime - %s' % (ctx.guild.name,
                                                                                       data['title']['romaji']))
                            except Exception as e:
                                error_embed = discord.Embed(
                        ...
                        error_embed = discord.Embed(
                            ...
                            color=0xff0000)
                        await ctx.channel.send(embed=error_embed)
                        bot.logger.info('Server: %s | Response: API Error' % ctx.guild.name)


def setup(client):
    client.add_cog(Anime(client))
    bot.logger.info('Loaded extension Anime')


def teardown():
    bot.logger.info('Unloaded extension Anime')
