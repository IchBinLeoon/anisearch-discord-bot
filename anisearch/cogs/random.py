                    ...
                    if r.status == 200:
                        ...
                        if json['data']['Page']['media']:
                            ...
                            try:
                                ...
                                bot.logger.info('Server: %s | Response: Random Anime - %s' % (ctx.guild.name,
                                                                                              data['title'][
                                                                                                        'romaji']))
                    ...
                    if r.status == 200:
                        ...
                        if json['data']['Page']['media']:
                            ...
                            try:
                                ...
                                bot.logger.info('Server: %s | Response: Random Manga - %s' % (ctx.guild.name,
                                                                                              data['title'][
                                                                                                        'romaji']))
                            except Exception as e:
                                error_embed = discord.Embed(
...
def setup(client):
    ...
    bot.logger.info('Loaded extension Random')


def teardown():
    bot.logger.info('Unloaded extension Random')
